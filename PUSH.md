...
## Push
    ...
    cd hydra
    git add .
    git commit -m "hydra v3.8.0 - high-loss FEC profiles, link tuning, diagnostics"
...
## Tag and release
    ...
    git tag -a v3.8.0 -m "hydra v3.8.0"
...
Manual alternative:
    ...
    gh release create v3.8.0 --title "hydra v3.8.0" --notes-file docs/RELEASE.md
